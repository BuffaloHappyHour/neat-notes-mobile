...
| F071 | Export Analytics Report | Analytics | High | v1.1.1 | Medium | Low | 💡 Idea | Post-event PDF/HTML analytics report generated from event tasting data. Delivered to hosts via "Export Analytics" button on the event host dashboard. Canonical format is colonial-event-report.html/.pdf. |
